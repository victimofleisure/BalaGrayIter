...
This software is connected to a [research paper](https://doi.org/10.5281/zenodo.16041343). If you use BalaGray in your research, please cite:

Korda, C. (2025). *Granular 12-Tone Harmony via Mixed-Radix Balanced Gray Codes:  
Interval Set Partitions and the BalaGray Solver*. [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.16041343.svg)](https://doi.org/10.5281/zenodo.16041343)
